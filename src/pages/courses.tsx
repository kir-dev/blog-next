          ...
          <BlogContainer>
            ...
            <Box mt={16}>
              ...
              <Text mt={4}>
                ...
                atmoszféra, gyakori szakmai poénok és segítőkész segédelőadók várnak. Nálunk nincsenek szigorú előkövetelmények, ha tudod,
                mik azok az alapvető adatstruktúrák, és hogy hogyan kell elágazásokat írni, már jó vagy. Az egyes alkalmakról minden
                tudnivalót (előadás témája, mit kell hozni, hova kell menni) előzetesen e-mail-ben fogsz megkapni az előadás előtt.
              </Text>
              ...
              <Flex mt={10} direction={{ base: 'column', md: 'row' }}>
                <Heading as="h3" size="md">
                  ...
                  A résztvevők emailben kapnak a jelentkezés lezárása utáni napon értesítést.
                </Heading>
            ...
            <Box mt={16}>
              ...
              <Text mt={2}>
                ...
                csupán szeretnének valóban a körbe csatlakozni. Azonban ez csak akkor tud működni, ha úgy érkezel mentorprogramunkba, hogy
                már van egy alapszintű ismereted a megfelelő keretrendszerben, aminek mentorálási munkacsoportjába jelentkezel.
              </Text>
              <Text mt={2}>
