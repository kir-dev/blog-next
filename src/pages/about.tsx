            ...
            <AboutParagraph title="Kommunikáció" id="contact" titleSize={secondHeadingSize}>
              <Flex mt={6} direction={{ base: 'column', sm: 'row' }}>
                <Text pr={{ base: 0, sm: 10 }}>
                  ...
                  <chakra.span fontWeight="bold">{environment.socials.publicEmail}</chakra.span>, illetve gyere el gyűléseinkre a Schönherz
                  Kollégium <chakra.span fontWeight="bold">1319-es szobájába {environment.meetingStartTime}-kor</chakra.span>!
                </Text>
